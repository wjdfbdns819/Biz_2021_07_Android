...
/*
 Activity.class
  기본적으로 하는 일
   ...
   2. Activity 이름 짓기
        Activity 클래스는 UI와 관련된 파일을 1개 이상 연결한다
        이름이 Activity.java 라는 이름으로 작성하고,
         activity_이름.xml 이라는 이름으로 화면 구현 xml 파일을 작성
 */
public class MainActivity extends AppCompatActivity {
    ...
    /*
     on* () method는 대채로 event Handler 들이다
      Create 동작이 실행될때 같이 동반하여 작동되는 Method 이다
      작성하고 있는 App이 안드로이드 phone에서 생성될때
      작동하는 method이다
     
     안드로이드 App에서는 onCreate() method를 진입점 method로 취급한다
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        // 정통 자바에서는 interface를 impl 한 클래스를 작성하고,
        ...
        View.OnClickListener btn_click = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(v.getId() == R.id.btn_login) {
                    ...
                    Intent login_intent =
                            // MainActivity에서 Intent 클래스를 사용하여 인텐드를 생성하고, LoginActivity를 호출하면
                            new Intent(MainActivity.this, LoginActivity.class);

                    //startActivity() method를 사용하여 LoginActivity로 화면 전환
                    startActivity(login_intent);

                } else if(v.getId() == R.id.btn_next) {
                    /*
                       Intent(인텐트)
                        Android에서 Activity를 부르는 다른 이름임
                         Activity의 super parent 클래스 이다
                        
                        새로운 Activity를 보여주는 절차
                         1. Intent 클래스를 사용하여 인텐트 생성
                         2. startActivity() method를 호출하여 
                             새로운 Acitivity로 화면 전환
                             
                         startActivity()는 이미 준비된 method임
